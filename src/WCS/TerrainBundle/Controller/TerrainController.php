...
namespace WCS\TerrainBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use WCS\TerrainBundle\Entity\Terrain;
use WCS\TerrainBundle\Form\TerrainType;
...
class TerrainController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WCSTerrainBundle:Terrain')->findAll();

        return $this->render('WCSTerrainBundle:Terrain:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WCSTerrainBundle:Terrain:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WCSTerrainBundle:Terrain')->find($id);
        ...
        return $this->render('WCSTerrainBundle:Terrain:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WCSTerrainBundle:Terrain:edit.html.twig', array(
            'entity'      => $entity,
